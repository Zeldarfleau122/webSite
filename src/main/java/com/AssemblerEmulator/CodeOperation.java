...
public enum CodeOperation {
    ...
    CodeOperation(final int code) {
        this.code = code ;
    }

    public static CodeOperation getCode(int instructionCode) {
        for (CodeOperation co : CodeOperation.values()) {
            if (co.code == instructionCode)
                return co ;
        }
        return null ;
    }
